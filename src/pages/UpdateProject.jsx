...
const UpdateProject = () => {
  ...
  const handleDeleteProject = async (id) => {
    if (!window.confirm("هل أنت متأكد من حذف هذا المشروع وكل بياناته؟")) return;
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-2 sm:px-4 py-8 min-h-[calc(100vh-60px)]">
      <span
        ...
        style={{
          ...
          background: "linear-gradient(90deg, rgba(191,219,254,0.45) 0%, rgba(219,234,254,0.60) 35%, rgba(239,246,255,0.50) 65%, rgba(191,219,254,0.45) 100%)",
          ...
          <div
            ...
            <div className="flex flex-col gap-3 mt-4">
              <button
                ...
                className="w-full bg-gradient-to-r from-yellow-200 via-yellow-100 to-yellow-200 hover:from-yellow-300 hover:to-yellow-200 text-yellow-900 font-extrabold py-2.5 rounded-xl shadow transition-all duration-150 text-base flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-yellow-300"
                style={{
                  fontFamily: "'Tajawal', 'Cairo', sans-serif",
              ...
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 12H9m6 0a6 6 0 11-12 0 6 6 0 0112 0zm6 0a6 6 0 11-12 0 6 6 0 0112 0z" />
                </svg>
                <span>تعديل بيانات المشروع</span>
              </button>
              <button
                onClick={() => navigate(`/update-worker/${p._id}`)}
              ...
              >
                ...
                <span>تعديل بيانات عامل</span>
              </button>
              <button
                onClick={() => navigate(`/update-worker-monthly/${p._id}`)}
              ...
              >
                ...
                <span>تعديل بيانات عامل الشهرية</span>
              </button>
              <button
                onClick={() => navigate(`/update-project-monthly/${p._id}`)}
              ...
              >
                ...
                <span>تعديل بيانات المشروع الشهرية</span>
              </button>
              <button
                onClick={() => handleDeleteProject(p._id)}
                className="w-full bg-gradient-to-r from-red-200 via-red-100 to-red-200 hover:from-red-300 hover:to-red-200 text-red-700 font-extrabold py-2.5 rounded-xl shadow transition-all duration-150 text-base flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-red-300"
                style={{
                  fontFamily: "'Tajawal', 'Cairo', sans-serif",
                  letterSpacing: "0.01em",
                }}
